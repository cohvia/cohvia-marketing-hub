...
const NarrativePreview = () => (
  <div className="relative">
    ...
    <div className="hidden md:flex absolute -left-10 top-32 items-center gap-2 surface-card rounded-lg px-3 py-2 shadow-lg animate-fade-in animation-delay-300">
    ...
    <div className="hidden md:flex absolute -right-8 bottom-20 items-center gap-2 surface-card rounded-lg px-3 py-2 shadow-lg border-primary/30 animate-fade-in animation-delay-500">
